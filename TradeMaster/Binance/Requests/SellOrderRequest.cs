...
public record SellOrderRequest : BaseRequest
{
    private readonly InternalOrderType _orderType;

    public SellOrderRequest(Coin baseCoin, Coin quotedCoin, InternalOrderType orderType, decimal quantity, decimal price) 
